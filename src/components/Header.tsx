    ...
    <header className="header">
      <div className="header-top container">
        ...
        <div className="header-actions">
          ...
          <div className="icon-actions">
            ...
            <button className="icon-btn avatar" aria-label="Account">
      ...
      <div className="header-bottom">
        <div className="container sub-nav">
          <span className="sub-nav-item"><span className="diamond">♦</span> BIS Hallmarked Gold</span>
          <span className="sub-nav-item"><span className="diamond">♦</span> Luxury You Can Feel</span>
          <span className="sub-nav-item"><span className="diamond">♦</span> Elegance That Lasts Forever</span>
          <span className="sub-nav-item"><span className="diamond">♦</span> Nayzora Jewellery Collection</span>
          <span className="sub-nav-item"><span className="diamond">♦</span> Crafted in Pure Perfection</span>
        </div>
      </div>
    </header>
  );
